...
export const HERMES_PROVIDER_CATALOG: Array<ProviderDef> = [
  ...
  { id: 'xai', name: 'xAI (Grok)', kind: 'api_key', envKeys: ['XAI_API_KEY'], models: [] },
  { id: 'alibaba', name: 'Qwen Cloud', kind: 'api_key', envKeys: ['DASHSCOPE_API_KEY'], models: [] },
  ...
  { id: 'copilot', name: 'GitHub Copilot', kind: 'api_key', envKeys: ['COPILOT_GITHUB_TOKEN', 'GITHUB_TOKEN'], models: [] },
  { id: 'stepfun', name: 'StepFun', kind: 'api_key', envKeys: ['STEPFUN_API_KEY'], models: [] },
  ...
  { id: 'ai-gateway', name: 'Vercel AI Gateway', kind: 'api_key', envKeys: ['AI_GATEWAY_API_KEY'], models: [] },
  ...
  { id: 'lmstudio', name: 'LM Studio', kind: 'api_key', envKeys: ['LM_API_KEY'], models: [] },
