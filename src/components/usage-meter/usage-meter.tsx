    ...
    <>
      {visible ? (
        <MenuRoot>
          <MenuTrigger
            className={cn(
              // Mobile: first-fix position - lifted above input bar, compact.
              // Desktop: even higher above composer area.
              "absolute bottom-24 right-2 md:bottom-32",
              ...
              'opacity-80 md:opacity-100 shadow-sm',
              alertTone,
            )}
